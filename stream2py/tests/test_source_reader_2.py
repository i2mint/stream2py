from stream2py.tests.utils_for_testing import TenthSecondCounter2
from stream2py.stream_buffer import StreamBuffer
from stream2py.source_reader_2 import SourceReader2
import time


def test_source_reader_2():

    sc_reader = TenthSecondCounter2()  # source
    with sc_reader:
        sc_buf = sc_reader.stream_buffer
        time.sleep(2)
        assert sc_reader.info['bt'] != 0, sc_reader.info
